...
namespace Milestone3
{
    public partial class CustomerRegister : System.Web.UI.Page
    {
        ...
        protected void CustReg(object sender, EventArgs e)
        {
            ...
            string username = CustUserReg.Text;
            string firstname = FNameCustReg.Text;
            string lastname = LNameCustReg.Text;
            string password = CustPassReg.Text;
            string email = CustMailReg.Text;
